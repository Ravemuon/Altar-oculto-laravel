...
<div class="container my-5">
    ...
    <div class="card shadow border-0 rounded-4 p-4">
        ...
        <div class="mt-4 text-center d-flex flex-column gap-2">
            ...
            {{-- Botões apenas para fornecedores --}}
            @if(Auth::user()->fornecedor)
                <a href="{{ route('fornecedores.index') }}" class="btn btn-success">
                    🏪 Ver Meus Fornecedores
                </a>
                <a href="{{ route('fornecedores.estoque', Auth::user()->fornecedor->id) }}" class="btn btn-warning">
                    📦 Ver Estoque
                </a>
            @endif
